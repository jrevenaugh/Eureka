                    ...
                    column(3,
                      wellPanel(
                        ...
                        sliderInput(inputId = "ARc",
                                    label = HTML(paste0("Crustal Density (gm/cm", tags$sup(3), ")")),
                                    min = 2, max = 4, step = 0.01,
                                    value = 2.7),

                        sliderInput(inputId = "ARm",
                                    label = HTML(paste0("Mantle Density (gm/cm", tags$sup(3), ")")),
                                    min = 2.5, max = 4.5, step = 0.01,
                                    value = 3.3 ),

                        radioButtons(inputId = "Alandorsea",
                                     label = "Land or Sea?",
                                     choices = c("Land" = 1, "Sea" = 2),
                                     selected = 1),
                        ...
                        fluidRow(
                          ...
                          column(6,
                            sliderInput(inputId = "Rc",
                                        label = HTML(paste0("Density (gm/cm", tags$sup(3), ")")),
                                        min = 2, max = 4, step = 0.01,
                                        value = 2.5 )
                          )
                        ),
